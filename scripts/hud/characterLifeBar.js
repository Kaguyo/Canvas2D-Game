...
function setEnergyBar (percentage) {
...
function setHealthBar (percentage) {
    ...
    setHealthBarColor(healthBar1, healthBar2, healthBar3, healthBloodBar1, healthBarBackground)
}

function setHealthBarColor(hBar1, hBar2, hBar3, hBloodBar1, hBarBackground) {
    if (hBar1.style.width.split('%')[0] >= 60) {
    ...
    } else if (hBar1.style.width.split('%')[0] > 20) {
